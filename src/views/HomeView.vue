        ...
        <div class="container-fluid second-row-container mt-5">
            <div class="container">
                <div class="row" id="statistic">
                    <h4 class="mt-3 mb-4 ms-3" style="border-bottom: 1px solid #ddd; padding:2% 0;">Data in Statistic</h4>
                </div>
                <div class="row">
                    <div class="col-4">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getChartData() {
                axios.get('http://localhost:8000/api/public/region')
                    .then(response => {
                        console.log(response);
            ...
            renderChart() {
                ...
                Highcharts.chart('HomeCityChartContainer', {
                    ...
                    colors: ['#F7A35C', '#90ED7D','#8085E9', '#F15C80', '#E4D354', '#2B908F', '#F45B5B', '#91E8E1'],
                    title: {
                        text: 'Cities'
                    },
                    xAxis: {
                ...
                Highcharts.chart('HomeUniversityChartContainer', {
                    ...
                    colors: ['#434348', '#8085E9', '#F15C80', '#E4D354', '#2B908F', '#F45B5B', '#91E8E1'],              
                    title: {
                        text: 'Universities'
                    },
                    xAxis: {
